...
particle tracking isn't modelling, rather its an analysis of a model output, taken at a static/steady state.


POlease note that there are many mehtodologies tha can be applied to particale traning, we have chosen what most convienient.  Also take not of the numerocal model cell/element size/orientation as this too will have effects on the particla pathline calculation